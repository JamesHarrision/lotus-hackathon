    ...
    <div className="min-h-screen bg-zinc-950 text-white selection:bg-indigo-500/30 overflow-x-hidden">
      ...
      <nav className="relative z-50 flex items-center justify-between px-6 py-8 md:px-12 max-w-7xl mx-auto">
        <div className="flex items-center gap-2 group cursor-pointer" onClick={() => navigate("/")}>
          ...
          <span className="text-xl font-black tracking-tighter uppercase italic">SmartRoute</span>
        </div>
        ...
        >
          ...
          <motion.div variants={itemVariants} className="flex flex-col md:flex-row gap-4">
            <Button 
              ...
              className="h-16 px-8 rounded-2xl bg-white text-black hover:bg-zinc-200 font-black text-lg group transition-all"
            >
            ...
            <Button 
              size="lg" 
              variant="outline"
              className="h-16 px-8 rounded-2xl border-zinc-800 hover:bg-zinc-900/50 font-black text-lg"
            >
              View Documentation
            </Button>
          </motion.div>
      ...
      <section className="py-32 px-6 text-center max-w-4xl mx-auto space-y-12">
        ...
        <p className="text-zinc-600 font-medium">Join over 200+ companies already scaling with SmartRoute AI.</p>
      </section>
      ...
      <footer className="py-20 border-t border-white/5 px-6 md:px-12 max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-12 text-zinc-500 font-medium text-sm">
        <div className="flex items-center gap-2 grayscale brightness-50">
          ...
          <span className="font-black tracking-tighter uppercase italic">SmartRoute AI</span>
        </div>
        ...
        <div>
          © 2026 SmartRoute Labs. Engineered with precision.
        </div>
      </footer>
    </div>
  );
